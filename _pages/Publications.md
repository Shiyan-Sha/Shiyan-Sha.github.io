...
<div class="pub-row" style="display: flex; align-items: center; flex-wrap: wrap; margin-bottom: 40px;">
  ...
  <div class="col-sm-9" style="flex: 1; padding-left: 0;">
    <div>
      <div class="title"><a href="/files/5. Characteristics of "Flash Mob" behavior and cultural transmission in public space based on an inclusive perspective- Evidence from Tianjin City, China.pdf">[3] Characteristics of "Flash Mob" behavior and cultural transmission in public space based on an inclusive perspective- Evidence from Tianjin City, China</a></div>
