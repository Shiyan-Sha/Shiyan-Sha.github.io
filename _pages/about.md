...
<div class="pub-row" style="display: flex; flex-direction: column; align-items: center; margin-bottom: 40px; text-align: center;">
  ...
  <div class="col-sm-9" style="flex: 0 0 auto; width: 800px;">
    <div>
